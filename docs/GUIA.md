...
├── src/
│   ├── __init__.py
│   ├── data_loader.py       # Funciones sencillas para leer y validar los datos
│   └── features.py          # Funciones para transformar variables (escalado, codificación)
├── docs/
│   └── GUIA.md              # Este plan de trabajo
├── requirements.txt         # Lista limpia de las 6 librerías principales
